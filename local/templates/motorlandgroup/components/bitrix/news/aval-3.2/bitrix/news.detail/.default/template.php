...
<div class="content models">
			...
			<div class="container">
				...
				<ul class="breadcrumb">
					...
					<li><a href="/used-cars/">Автомобили с пробегом</a></li>
				...
				<div class="car-info">
					...
					<?/*<div class="car-info-mid">
						<h2>Описание</h2>
						<p>Volvo XC90 — это потрясающий автомобиль, который сочетает в себе мужественный внешний облик и утонченный интерьер. Оказавшись внутри, вы оцените непревзойденное удобство и совершенство каждой детали. Например, эргономичные сиденья, идеально повторяющие форму человеческого тела, сделают каждую вашу поездку максимально комфортной.</p>
					</div>*/?>
				</div>
...
<div class="container">
	<h2 class="title" style="width:100%; text-align:center;">Новые автомобили в наличии</h2>
		<?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"avaonprime", 
	array(
